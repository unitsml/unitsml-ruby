...
RSpec.describe Unitsml::Parser do
  subject(:formula) do
    described_class.new(exp).parse.to_latex(
  ...
  context "contains Unitsml #1 example" do
    ...
    let(:expected_value) do
      'm\\ensuremath{\\mathrm{m}}/\\ensuremath{\\mathrm{s}}^(-2)'
    end
  ...
  context "contains Unitsml #12 example" do
    ...
    let(:expected_value) do
      'k\\ensuremath{\\mathrm{g}}/\\ensuremath{\\mathrm{s}}^(-2)'
    end
  ...
  context "contains Unitsml #18 example" do
    ...
    let(:expected_value) do
      '\\ensuremath{\\mathrm{A}}/\\ensuremath{\\mathrm{C}}^3'
    end
  ...
  context "contains Unitsml #20 example" do
    ...
    let(:expected_value) do
      '\\ensuremath{\\mathrm{J}}/k\\ensuremath{\\mathrm{g}}^-1/\\ensuremath{\\mathrm{K}}^-1'
    end
  ...
  context "contains Unitsml #23 example" do
    ...
    let(:expected_value) do
      'm\\ensuremath{\\mathrm{W}}/c\\ensuremath{\\mathrm{m}}^-2'
    end
  ...
  context "contains Unitsml #24 example" do
    ...
    let(:expected_value) do
      '\\ensuremath{\\mathsf{\\Theta}}/\\ensuremath{\\mathsf{L}}^(2)'
    end
  ...
  context "contains Unitsml #25 example" do
    ...
    let(:expected_value) do
      '\\ensuremath{\\mathsf{\\Theta}}^10/\\ensuremath{\\mathsf{L}}^((2))'
    end
  ...
  context "contains Unitsml #26 example" do
    ...
    let(:expected_value) do
      '\\ensuremath{\\mathrm{Hz}}^10/\\ensuremath{\\mathrm{d}}^100'
    end
  ...
  context "contains Unitsml #30 example for explicit_parenthesis: false" do
    let(:exp) { "unitsml(((Hz^10)*darcy^100))" }
    let(:expected_value) do
      '\\ensuremath{\\mathrm{Hz}}^10/\\ensuremath{\\mathrm{d}}^100'
    end
  ...
  describe "implicit extender" do
    context "implicit extender example #1 from issue#53" do
      let(:exp) { "unitsml(J(kg*K))" }
      let(:expected_value) do
        '\\ensuremath{\\mathrm{J}}(k\\ensuremath{\\mathrm{g}}/\\ensuremath{\\mathrm{K}})'
      end
    ...
    context "implicit extender example #3 from issue#53" do
      ...
      let(:expected_value) do
        '\\ensuremath{\\mathrm{J}}/\\ensuremath{\\mathrm{mol}}^-1/\\ensuremath{\\mathrm{K}}^-1'
      end
    ...
    context "implicit extender example #5" do
      ...
      let(:expected_value) do
        '(\\ensuremath{\\mathrm{mol}}/\\ensuremath{\\mathrm{K}})\\ensuremath{\\mathrm{J}}'
      end
    ...
    context "implicit extender example #8" do
      ...
      let(:expected_value) do
        '(\\ensuremath{\\mathrm{mol}}/\\ensuremath{\\mathrm{K}})(\\ensuremath{\\mathrm{J}}/\\ensuremath{\\mathrm{K}})'
      end
    ...
    context "implicit extender example #9" do
      ...
      let(:expected_value) do
        '\\ensuremath{\\mathrm{E}}(m\\ensuremath{\\mathrm{m}})/k\\ensuremath{\\mathrm{g}}'
      end
    ...
    context "implicit extender example #10" do
      ...
      let(:expected_value) do
        '\\ensuremath{\\mathsf{\\Theta}}(\\ensuremath{\\mathsf{\\phi}})'
      end
    ...
    context "implicit extender example #11" do
      ...
      let(:expected_value) do
        '(\\ensuremath{\\mathsf{\\Theta}})\\ensuremath{\\mathsf{L}}'
      end
    ...
    context "implicit extender example #13" do
      ...
      let(:expected_value) do
        '\\ensuremath{\\mathsf{\\phi}}(\\ensuremath{\\mathsf{\\Theta}}/\\ensuremath{\\mathsf{L}})'
      end
    ...
    context "implicit extender example #14" do
      ...
      let(:expected_value) do
        '(\\ensuremath{\\mathsf{\\phi}}(\\ensuremath{\\mathsf{I}}))((\\ensuremath{\\mathsf{\\Theta}})\\ensuremath{\\mathsf{L}})'
      end
