...
require "unitsml/errors/misplaced_extender_error"
...
# PowerNumerator must be defined before Unit/Dimension include its storage mixin
# (no lazy autoload under Opal).
